...
function generatePoem(event) {
    ...
    let theContext = `You are a helpful artificial intelligence assistant that easily creates poems. When asked to generate a poem, your answer is a poem about the topic ${userInstructionsElement.value}, written as four short verses, each verse in its own line and followed by the author's signature, which is SheCodes AI (<p>verse 1<br />verse 2<br />verse 3<br />verse 4</p><p class="poem-author">SheCodes AI</p>)`;
...
new Typewriter("#poem-text", {
    strings: "A poem written just for you!",
    autoStart: true,
    cursor: "",
    delay: 10,
});
